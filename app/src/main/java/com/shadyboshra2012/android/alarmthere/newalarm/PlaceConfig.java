...
public final class PlaceConfig {

    public static final String TAG = "AlarmThere";
    ...
    public static final String GOOGLE_BROWSER_API_KEY =
            "AIzaSyCnwCY8Hu_ZZaCF0Dhs8tjR9FLemiemos8";
    public static final int PLAY_SERVICES_RESOLUTION_REQUEST = 9000;
    public static final int PROXIMITY_RADIUS = 200;
    public static final String LOCALE_LANGUAGE = Locale.getDefault().getLanguage();
